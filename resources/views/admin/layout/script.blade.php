...
<script>
    ...
    function tampilHasilNormalisasiJarak(data) {
        ...
        var normalizedData = [];
        var length = Math.max((data.normalizedData1.length), (data.normalizedData2.length*data.normalizedData2.length));
        // var length = Math.max(data.normalizedData1.length);
        for (var i = 0; i < length; i++) {
            ...
            //     'nama': data2.nama,
            //     'nama2': data1.nama2,
            //     'Klasifikasi': data2.Klasifikasi,
            //     'jarak': data2.jarak,
            // });
            // pengulangan .push dilakukan untuk mengurutkan data
        }
